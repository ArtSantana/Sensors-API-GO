...
// CreateSensor repository
func CreateSensor(sensorModel models.Sensor) (bool, models.Sensor) {
	var err bool
	err = db.NewRecord(sensorModel)
	db.Create(&sensorModel)
	err = db.NewRecord(sensorModel)

	if err {
		return true, sensorModel
	}

	return false, sensorModel
}
